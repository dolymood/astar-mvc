...
AstarView.prototype = {
    init: function () {
        ...
        this.createMap();
        this.renderBlocks(50);
    },
    renderRect: function (x, y) {
        this.ctx.fillRect(40 + this.dx * x, 40 + this.dy * y, this.dx, this.dy);
    ...
    renderPath: function (path) {
        ...
        setTimeout(function () {
            ...
            self.ctx.fillRect(40 + self.dx * point.x, 40 + self.dy * point.y, self.dx, self.dy);
    ...
    removePath: function () {
        ...
        for (var i = 0, len = this.blocks.length; i < len; i++) {
            ...
            this.ctx.fillRect(40 + this.dx * block[0], 40 + this.dy * block[1], this.dx, this.dy);
